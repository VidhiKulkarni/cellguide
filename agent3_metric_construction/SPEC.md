...
- No CRISPRi/CRISPRa scoring — `agent2_literature_summarization/output/SUMMARY.md` notes that none of the 18 papers pulled so far cover CRISPRi/CRISPRa, consistent with the plan's SpCas9-knockout-oriented MVP scope.
